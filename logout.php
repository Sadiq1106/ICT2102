   ...
   <body class="form-v8">
      ...
      <div class="page-content">
         <div class="form-v8-content">
            ...
            <span class="login100-form-title" style="position: relative;top: 180px;">
                  <h1 style="color:white;">You have logged out successfully</h1>      
         <button type="button" onclick="location.href='login.php'"class="btn btn-light">Click here to login</button>
               </span>
            </div>
         </div>
      </div>
