...
<html>
   ...
   <body class="form-v8">
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-lg-4 col-md-6">
                  ...
                  <div class="text-component text-center">
                     <p class="flex flex-wrap flex-center flex-gap-xxs">  
                        <a href="#0" class="cd-add-to-cart js-cd-add-to-cart" data-price="10">Add To Cart</a>
                     </p>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6">
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="single_place">
                     <div class="thumb">
                        <img src="img/place/koreanair.png" alt="">
                        <a href="#" class="prise">$550</a>
                     </div>
                     <div class="place_info">
                        <a href="destination_details.html">
                           <h3>Korean Air</h3>
                        </a>
                        <p>Incheon Airport, Seoul</p>
                        <div class="rating_days d-flex justify-content-between">
                           <span class="d-flex justify-content-center align-items-center">
                           <i class="fa fa-star"></i> 
                           <i class="fa fa-star"></i> 
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="single_place">
                     <div class="thumb">
                        <img src="img/place/asiana.png" alt="">
                        <a href="#" class="prise">$590</a>
                     </div>
                     <div class="place_info">
                        <a href="destination_details.html">
                           <h3>Asiana Airlines</h3>
                        </a>
                        <p>Incheon Airport, Seoul</p>
                        <div class="rating_days d-flex justify-content-between">
                           <span class="d-flex justify-content-center align-items-center">
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="single_place">
                     <div class="thumb">
                        <img src="img/place/jejuair.png" alt="">
         ...
         <div class="cd-cart__content">
            <div class="cd-cart__layout">
               ...
               <footer class="cd-cart__footer">
                  <a href="payment.html" class="cd-cart__checkout">
                     <em>
      ...
      <!-- cd-cart -->
      <script src="js/cartutil.js"></script> <!-- util functions included in the CodyHouse framework -->
