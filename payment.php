...
<html>
   ...
   <div class='checkout'>
      <div class='order'>
         ...
         <ul class='order-list'>
            <li>
               <img src='img/place/ana.png'>
               <h4>Flight: ANA</h4>
               <h5>$100</h5>
            </li>
            <li>
               <img src='img/place/mandarin.png'>
               <h4>Hotel: Mandarin Hotel</h4>
               <h5>$100</h5>
            </li>
            <li>
               <img src='img/place/fuji.png'>
               <h4>Activities: Mt Fuji</h4>
               <h5>$100</h5>
            </li>
            
         </ul>
         <h5>Tax and Service Charge</h5>
         <h4>$100</h4>
      ...
      <div id='payment' class='payment'>
         ...
         <div class='card-form'>
            ...
            <button onclick="document.getElementById('id01').style.display='block'"  class='button-cta' title='Confirm your purchase'><span>PURCHASE</span></button>
            ...
            <div id="id01" class="modal">
               ...
               <form class="modal-content" action="#">
                 <div class="container">
                   ...
                   <p>Are you sure you want to proceed payment? </p>
                 
                   <div class="clearfix">
                     <button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn">Cancel</button>
                     <button onclick="location.href='bookingconfirmation.php'" type="button" onclick="document.getElementById('id01').style.display='none'" class="deletebtn">Yes</button>
                   </div>
                 </div>
               </form>
             </div>
